...
{Clair3_path}/run_clair3.sh --bam_fn={controlBam} --ref_fn={reference} --threads={threads} --platform="ont" --model_path={Clair3_path}/r941_prom_hac_g238 --output={saveDir}  --enable_phasing --longphase_for_phasing 
